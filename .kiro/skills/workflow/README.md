...
Process orchestration and project management

**Total:** 1 skill

## Skills in This Domain

- **ai-dlc-orchestrator** (`ai-dlc-orchestrator`)
...
mklink /J ".kiro\skills\workflow\{subdomain}\{skill-name}" "..\..\..\.agents\skills\{skill-name}"
